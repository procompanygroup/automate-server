                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a
                                    href= "{{ url('/admin/design/sections','main-menu') }}">{{ __('general.sections', [], 'en') }}</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="card card-info">
                ...
                <div class="card-body  row">
                    <div class="col-lg-12 form-separate" >
                        <form class="form-horizontal" name="create_form" method="POST" action="{{route('category.updatemenu', $item->id)}}" 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"  @readonly(true) class="form-control" name="title" id="title"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <a class="btn btn-danger float-right " href="{{ url('/admin/design/sections','main-menu') }}">Cancel</a>
                              ...
                              <div class="card-body">
                                <div class="tab-content" id="trans-tabs-four-tabContent">
                                  ...
                                  <div class="tab-pane fade @once show active @endonce " id="lang-{{$lang->id}}" role="tabpanel" aria-labelledby="lang-{{$lang->id}}-tab">
                                    <form class="form-horizontal" name="update_trans_form-{{$lang->id}}" method="POST" action="{{route('langcategory.update', $item->id)}}" 
